			...
			<div class="form-group">
				...
				<div class="row">
					<div class="col-md-6 col-lg-5 col-xl-4 mb-3">
						...
						<select id="txtTypeExchange" class="form-select form-select-sm"><option value="0" selected>Selecciona tipo de movimiento</option></select>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6 col-lg-5 col-xl-4 mb-3">
						<label for="txtStoreSource" class="form-label">Almacen Origen</label>
						<select id="txtStoreSource" class="form-select form-select-sm"><option value="0" selected>Selecciona almacen</option></select>
					</div>
					<div class="col-md-6 col-lg-5 col-xl-4 mb-3">
				...
				<div class="row">
					<div class="col-md-12 col-lg-10 col-xl-8 mb-3">
						...
						<select id="txtProducts" class="form-select form-select-sm"><option value="0" selected>Selecciona producto</option></select>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12 col-lg-10 col-xl-8 mb-3">
						<label for="txtComments" class="form-label">Comentarios</label>
						<textarea class="form-control form-control-sm" id="txtComments" rows="3"></textarea>
					</div>
				</div>
				<div class="row">
