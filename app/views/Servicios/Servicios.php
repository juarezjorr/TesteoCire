...
<body class="">
			<div class="container">
				<div class="row" style="margin-bottom: 10px !important;">
					...
					<button id="nuevoServicios" type="button" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#ServiciosModal">
                    <i class="fas fa-cube marginR"></i>  Nuevo Servicio
					</button>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-12 col-md-12">		
                      <table id="ServiciosTable" class="table table-striped table-bordered dt-responsive nowrap table-hover" style="width:100%">         
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Nombre</th>
         ...
         <div class="modal-body">
            <div class="row">
               <div class="col-12 text-center">
                  <span class="" id="ServciosModalLabel" style="font-weight: 600; font-size: 1.2rem;"><i class="fas fa-cube"></i> Nuevo Servicio:</span>
               </div>
            </div>
            <form id="formCategorias" class="row g-3 needs-validation" novalidate>
               <div class="row" style="width:  100% !important;">
                  <input hidden type="text" class="form-control" id="IdServicio" aria-describedby="basic-addon3" autocomplete="off">

                  <div class="col-12 col-espace">
                     <input name="nem" type="text" class="form-control" id="NomServicio"  placeholder="Nombre..." autocomplete="off" required>
                  ...
                  <div class="col-12 col-espace">
                     <textarea class="form-control" id="DesServicio" aria-label="With textarea" placeholder="Descripcion..."  autocomplete="off" required></textarea>
                     <div class="invalid-feedback">
            ...
            <div>
               <div class="modal-footer">
                  <div class="col-12" style="padding: 0px 70px 0px 70px !important;">
                     <button type="button"  class="btn btn-primary btn-lg btn-block" style="font-size: 1rem !important;" id="GuardarServicio">Guardar Servicio</button>
                  </div>
               </div>
            </div>
         </div>
