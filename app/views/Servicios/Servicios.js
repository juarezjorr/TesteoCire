            ...
            if(IdServicio != ''){
             ...
             if ((respuesta != 0)) {
                ...
                var rowNode = table.row.add( {
                   [0]:  '<button onclick="EditServicios('+respuesta+')" type="button" class="btn btn-default btn-icon-edit" aria-label="Left Align"><i class="fas fa-pen modif"></i></button><button onclick="ConfirmDeletServicio('+respuesta+')" type="button" class="btn btn-default btn-icon-delete" aria-label="Left Align"><i class="fas fa-times-circle kill"></i></button>',
                   [1]:   respuesta,
                   [2]:   NomServicio,
                   [3]:   DesServicio
                }).draw().node();
          ...
          respuesta.forEach(function (row, index) {
             renglon =
                ...
                '<td class="text-center edit"> ' +
                    '<button onclick="EditServicios(' + row.srv_id +')" type="button" class="btn btn-default btn-icon-edit" aria-label="Left Align"><i class="fas fa-pen modif"></i></button>' +
                    '<button onclick="ConfirmDeletServicio(' + row.srv_id +')" type="button" class="btn btn-default btn-icon-delete" aria-label="Left Align"><i class="fas fa-times-circle kill"></i></button>' +
                '</td>' +
