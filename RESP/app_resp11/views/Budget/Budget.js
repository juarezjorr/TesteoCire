...
function show_minimenues(idsel, x, y) {
    ...
    if (inic == 'day') {
        ...
        <div class="box_desc">
            <ul>
                <li data_content="0.0">0%</li>    
                <li data_content="0.05">5%</li>
                <li data_content="0.1">10%</li>
                <li data_content="0.15">15%</li>
                <li data_content="0.20">20%</li>
            </ul>
        </div>
        `;
        $('body').append(H);
...
function save_costumer() {
    ...
    // var pagina = 'Budget/SaveCustomers';
    // var tipo = 'json';
    // var selector = put_customers;
    // fillField(pagina, par, tipo, selector);
