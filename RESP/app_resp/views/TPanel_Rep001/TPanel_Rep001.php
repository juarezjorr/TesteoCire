...
<div class="sb_panel">
    ...
    <div class="contenido">
        <div class="lstReportes border">
            <h1>Reporte de salidas <br><small>(unidades)</small></h1>
            <div class="panel">
                <div class="grafica grafica_4">
                    <table id="tblSalidas" class="datatable display"  ></table>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="<?=  PATH_VIEWS . 'TPanel_Rep001/TPanel_Rep001.js' ?>"></script>
