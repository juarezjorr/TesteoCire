...
<div class="container">
    <div class="frame_main central">
        <h1>Registro de entradas de unidades</h1>
        <div class="frame_inside border">
            <div class="frame_list">
                <!-- Listado de vehiculos en salida -->
                <div class="listado">
                ...
                <div class="unidad">
                    ...
                    <div class="frame_inputs">
                        ...
                        <div class="form_group seg_km_salida">
                            <h2>Entrada</h2>
                            <label for="txtUndKmRegis">Kilómetros registrados en la unidad</label><br />
                            <div class="group_simple">
                                <input type="number" name="txtUndKmRegis" id="txtUndKmRegis" class="textbox requerido"
                        ...
                        <div class="form_group seg_Hr_salida noshow">
                            <label for="txtUndHrRegis">Horas registradas en la planta</label><br />
                            <div class="group_simple">
                                <input type="number" name="txtUndHrRegis" id="txtUndHrRegis" class="textbox requerido"
                    ...
                    <input type="hidden" name="txtUndLtReals" id="txtUndLtReals" />
                    <input type="hidden" name="txtPtaLtReals" id="txtPtaLtReals" />
...
<script src="<?=  PATH_VIEWS . 'EntryRecords/EntryRecords.js' ?>"></script>
