...
<div class="sb_panel">
    ...
    <div class="contenido">
        ...
        <h1>Reporte de salidas <br><small>(plantas)</small></h1>
            <div class="panel">
                <div class="grafica grafica_4">
                    <table id="tblSalidas" class="datatable display" style="max-width:1720px"></table>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="<?=  PATH_VIEWS . 'TPanel_Rep002/TPanel_Rep002.js' ?>"></script>
